    ...
    return (
        <>
            <nav className="bg-gray-800 max-w-[1240px] h-20 flex justify-between items-center mx-auto px-4">
                ...
                <div
                    className={`fixed md:hidden right-0 top-20 w-[40%] h-32 bg-gray-800 z-50 border-l-gray-700 flex flex-col duration-400 ease-in-out ${
                        !isOpen ? "flex" : "fixed right-[-100%]"
                    }`}
                >
                    <ul className="flex flex-col h-40 items-end">
                        <li className="text-white font-bold text-lg p-2">
                            <a
                                href="/progressus/login"
                                className="border-b-gray-800 p-4"
                            >
                                Bejelentkezés
                            </a>
                        </li>
                        <li className="text-white font-bold text-lg p-2 mt-4">
